#!/bin/bash
#===============================================================================
# TKT Philippines AVD Platform - V6.2 Deployment Script
# Version: 6.2
# Date: 2026-02-13
...
#
# USAGE:
#   bash deploy-avd-platform-v6.2.sh                    # Interactive mode
#   bash deploy-avd-platform-v6.2.sh --dry-run         # Preview only
#   bash deploy-avd-platform-v6.2.sh --config env.sh   # Use config file
#
