#!/bin/bash
#===============================================================================
# TKT Azure Platform - V9 Destruction Script
# Version: 9.0
# Date: 2026-02-17
#
# DESCRIPTION:
...
#   - Azure Firewall, firewall policy, route table
#   - Azure Key Vault (break-glass credentials) (V9)
#   - Conditional Access policies (V9)
#   - Microsoft Teams team (optional) (V9)
#   - NSG, VNet, and all networking
#   - Entra ID users (from users.json or ph-consultant-001 through 006)
#   - Entra ID break-glass admin (V9)
...
#===============================================================================
# V9 STEP 4.5: DELETE KEY VAULT
#===============================================================================

delete_key_vault() {
    log INFO "Step 4.5: Deleting Key Vault (V9)..."
...
#===============================================================================
# V9 STEP 4.6: DELETE CONDITIONAL ACCESS POLICIES
#===============================================================================

delete_conditional_access() {
    log INFO "Step 4.6: Deleting Conditional Access policies (V9)..."

    if [[ "$DRY_RUN" == "true" ]]; then
        log INFO "[DRY RUN] Would delete 3 CA policies and 2 named locations"
        return
    fi

    local policy_names=("TKT-PH-AVD-Require-MFA" "TKT-PH-AVD-Location-Restriction" "TKT-PH-AVD-Block-Legacy-Auth")
    for pname in "${policy_names[@]}"; do
        local pid=$(az rest --method GET \
...
#===============================================================================
# V9 STEP 4.7: DELETE BREAK-GLASS ADMIN
#===============================================================================

delete_break_glass() {
    log INFO "Step 4.7: Deleting break-glass admin (V9)..."

    if [[ "$DRY_RUN" == "true" ]]; then
        log INFO "[DRY RUN] Would delete break-glass: ${BREAK_GLASS_USERNAME}@${ENTRA_DOMAIN}"
        return
    fi
